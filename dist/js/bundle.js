...
window.MH.onReady(function () {
  var CANVAS = document.getElementById("game-canvas");
  var GAME_INSTANCE = new _game2.default(CANVAS);
...
var _snake = __webpack_require__(44);

var _food = __webpack_require__(128);

var _food2 = _interopRequireDefault(_food);

var _utils = __webpack_require__(129);

var _keyboard = __webpack_require__(130);

var _random = __webpack_require__(131);

var _random2 = _interopRequireDefault(_random);

var _forIn = __webpack_require__(136);
...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    key: "closeScreens",
    value: function closeScreens() {
      (0, _forIn2.default)(this.screens, function (screen) {
        screen.disable();
      });
    }
  }, {
    ...
    value: function registerActions() {
      ...
      (0, _utils.on)(".js-start", "click", function () {
    ...
    value: function setup() {
      ...
      (0, _keyboard.onKeyPress)([_keyboard.ARROW_UP, _keyboard.ARROW_RIGHT, _keyboard.ARROW_LEFT, _keyboard.ARROW_DOWN], function (key) {
        if (key === _keyboard.ARROW_DOWN) {
          _this2.snake.move(_snake.MOVE_DOWN);
        } else if (key === _keyboard.ARROW_UP) {
          _this2.snake.move(_snake.MOVE_UP);
        } else if (key === _keyboard.ARROW_LEFT) {
          _this2.snake.move(_snake.MOVE_LEFT);
        } else if (key === _keyboard.ARROW_RIGHT) {
          _this2.snake.move(_snake.MOVE_RIGHT);
        }
      });
    }
  }, {
    ...
    value: function shouldUpdate() {
      ...
      var shouldUpdate = delta > this.frameDelta;
    ...
    value: function update() {
      ...
      if (!this.food.length) {
        this.food.push(new _food2.default(this.generateRandomPoint(), 1, this));
      }
    }
  }, {
    key: "draw",
    ...
    key: "positionIsOccupied",
    value: function positionIsOccupied(point) {
    ...
    value: function generateRandomPoint() {
      ...
      do {
        point = new _point2.default((0, _random2.default)(0, this.grid.size - 1), (0, _random2.default)(0, this.grid.size - 1));
...
var Grid = function () {
  ...
  _createClass(Grid, [{
    ...
    key: "drawLine",
    value: function drawLine(axis, coordinate) {
      var originX = 0;
      var originY = 0;
      var destX = 0;
      var destY = 0;
    ...
    value: function getCellSize() {
      var smallestSize = this.context.canvas.width;
...
var MOVE_DOWN = exports.MOVE_DOWN = [0, 1];
...
var Snake = exports.Snake = function () {
  ...
  _createClass(Snake, [{
    ...
    key: "isSameDirection",
    value: function isSameDirection(directionA, directionB) {
    ...
    value: function isValidMove(direction) {
      ...
      if (this.isSameDirection(MOVE_DOWN, direction) && this.isSameDirection(MOVE_UP, currentDirection)) {
        return false;
      }

      if (this.isSameDirection(MOVE_UP, direction) && this.isSameDirection(MOVE_DOWN, currentDirection)) {
        return false;
      }

      if (this.isSameDirection(MOVE_LEFT, direction) && this.isSameDirection(MOVE_RIGHT, currentDirection)) {
        return false;
      }

      if (this.isSameDirection(MOVE_RIGHT, direction) && this.isSameDirection(MOVE_LEFT, currentDirection)) {
        return false;
      }
    ...
    key: "setConstraint",
    value: function setConstraint(min, max) {
      this.constraint = {
        min: min,
        max: max
      };
    ...
    key: "enforceConstraint",
    value: function enforceConstraint() {
      if (!this.constraint) {
        return false;
      }
    ...
    value: function update(delta) {
      ...
      if (this.game.food.length) {
        for (var i = 0, len = this.game.food.length; i < len; i++) {
        ...
        this.game.food = (0, _filter2.default)(this.game.food);
      }
    ...
    key: "drawBodyPart",
    value: function drawBodyPart(point) {
      this.context.beginPath();
      this.context.fillStyle = "#0f0";
      this.context.strokeStyle = "#666";

      this.context.rect(point.x * this.size + 1, point.y * this.size + 1, this.size - 2, this.size - 2);
...
var Food = function () {
  function Food(position, value, game) {
  ...
  _createClass(Food, [{
    ...
    value: function draw() {
      ...
      this.game.context.rect(this.position.x * size + size / 4, this.position.y * size + size / 4, size / 2, size / 2);
...
function getBackingStorePixelRatio(context) {
  ...
  return context.backingStorePixelRatio || context.webkitBackingStorePixelRatio || context.mozBackingStorePixelRatio || context.msBackingStorePixelRatio || context.oBackingStorePixelRatio || defaultRatio;
}
...
exports.ARROW_RIGHT = exports.ARROW_LEFT = exports.ARROW_DOWN = exports.ARROW_UP = undefined;
...
var baseRandom = __webpack_require__(132),
    isIterateeCall = __webpack_require__(133),
    toFinite = __webpack_require__(134);
...
var _screen = __webpack_require__(142);
...
var Gameover = function (_Screen) {
  _inherits(Gameover, _Screen);
